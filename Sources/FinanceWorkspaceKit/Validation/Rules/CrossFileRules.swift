...
enum CrossFileRules {
    ...
    private static let specs: [ReferenceSpec] = [
        .init(childType: "transactions", fkColumn: "account_id",        parentType: "registry",        parentColumn: "account_id",        ruleID: "VAL-CROSS-003", optional: false),
        .init(childType: "transactions", fkColumn: "category_id",       parentType: "categories",      parentColumn: "category_id",       ruleID: "VAL-CROSS-001", optional: true),
        .init(childType: "transactions", fkColumn: "savings_goal_id",   parentType: "goals",           parentColumn: "goal_id",           ruleID: "VAL-CROSS-008", optional: true),
        .init(childType: "registry",     fkColumn: "account_group_id",  parentType: "account-groups",  parentColumn: "account_group_id",  ruleID: "VAL-CROSS-002", optional: false),
        .init(childType: "liabilities",  fkColumn: "account_id",        parentType: "registry",        parentColumn: "account_id",        ruleID: "VAL-CROSS-003", optional: false),
        .init(childType: "assets",       fkColumn: "account_id",        parentType: "registry",        parentColumn: "account_id",        ruleID: "VAL-CROSS-003", optional: true),
        .init(childType: "prices",       fkColumn: "asset_id",          parentType: "assets",          parentColumn: "asset_id",          ruleID: "VAL-CROSS-004", optional: false),
        .init(childType: "dividends",    fkColumn: "asset_id",          parentType: "assets",          parentColumn: "asset_id",          ruleID: "VAL-CROSS-004", optional: false),
        .init(childType: "tax-lots",     fkColumn: "asset_id",          parentType: "assets",          parentColumn: "asset_id",          ruleID: "VAL-CROSS-004", optional: false),
        .init(childType: "portfolios",   fkColumn: "account_id",        parentType: "registry",        parentColumn: "account_id",        ruleID: "VAL-CROSS-003", optional: true),
        .init(childType: "sleeves",      fkColumn: "portfolio_id",      parentType: "portfolios",      parentColumn: "portfolio_id",      ruleID: "VAL-CROSS-006", optional: false),
        .init(childType: "sleeve-targets", fkColumn: "sleeve_id",       parentType: "sleeves",         parentColumn: "sleeve_id",         ruleID: "VAL-CROSS-007", optional: false),
        .init(childType: "progress",     fkColumn: "goal_id",           parentType: "goals",           parentColumn: "goal_id",           ruleID: "VAL-CROSS-008", optional: false),
        .init(childType: "budget-allocations", fkColumn: "category_id", parentType: "categories",      parentColumn: "category_id",       ruleID: "VAL-CROSS-001", optional: false),
    ]
